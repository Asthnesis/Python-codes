#  This program contains methods that when called output the details of a customer's bank account that are not limited to their account number, their name, details and withdrawal details and also their account balance
